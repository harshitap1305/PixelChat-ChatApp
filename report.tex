...
\begin{tikzpicture}[
    ...
    \node[vkbox, right=2cm of sys3] (vk) {Valkey\\Primary (Sys2)\\:4000};
    \node[vkbox, below=0.4cm of vk] (vkr) {Valkey\\Replica (Sys3/4)\\:4000};
...
\texttt{VALKEY\_PORT} & \texttt{4000} & Valkey primary port \\
\texttt{VALKEY\_REPLICA\_HOST} & \texttt{127.0.0.1} & Valkey replica IP (for reads) \\
\texttt{VALKEY\_REPLICA\_PORT} & \texttt{4000} & Valkey replica port \\
