...
\texttt{Sys1 (Load Balancer :8082)} $\xrightarrow{\text{Round-Robin}}$
$\begin{cases}
...
\midrule
stu70\_sys1 & Load Balancer & \texttt{ssh -p 2237 student@10.1.75.53} & 172.17.0.38 & 8082 \\
...
\textbf{[SCREENSHOT PLACEHOLDER]}\\[6pt]
Insert screenshot of \texttt{curl http://SYS1:8082/lb/status} showing all backends alive.
\vspace{2.5cm}}}
...
./load_balancer \
  ...
  -port 8082
\end{lstlisting}
    \item Verify: \texttt{curl http://localhost:8082/lb/health}
\end{enumerate}
...
and confirming ``Load Balancer running on :8082''
\vspace{2.5cm}}}
...
./load_balancer -backends http://172.17.0.39:8081 -port 8082

./load_generator -url 'http://localhost:8082/?delay=100ms' \
...
./load_balancer -backends http://172.17.0.39:8081,\
    http://172.17.0.40:8081,http://172.17.0.41:8081 -port 8082
...
\begin{itemize}[leftmargin=2em]
    ...
    \item The load balancer on Sys1 (port 8082) forwards requests to all three backends.
